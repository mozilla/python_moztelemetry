...
setup(
    ...
    install_requires=['boto', 'boto3', 'backports.lzma', 'ujson', 'requests', 'protobuf', 'expiringdict', 'functools32', 'futures', 'py4j', 'pandas>=0.14.1', 'numpy>=1.8.2', 'joblib', 'telemetry-tools', 'findspark'],
